...
#ifdef Debug
    const char *rtpUrl = "[select=a:f=rtp:ssrc=1111:payload_type=100]rtp://127.0.0.1:34044?rtcpport=34035|[select=v:f=rtp:ssrc=2222:payload_type=101]rtp://127.0.0.1:34094?rtcpport=34088";
#else
    char rtpUrl[512];
#endif
